...
const SignalList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  ${validate_component(LinkListBox, "LinkListBox").$$render($$result, {}, {}, {
			default: () => `
    ${each(signals.filter(f => f != null), frec => `${validate_component(UnderlineLink, "UnderlineLink").$$render(
				$$result,
				{
					href: signalUrl({
						lang: $lang,
    ...
    <div class="${"content svelte-8y35po"}">
      ...
      <div class="${"info"}">
		...
		? `<div class="${"data-wrap web svelte-8y35po"}">
            <p class="${"svelte-8y35po"}"><span class="${"label svelte-8y35po"}">${escape($trans("station.labels.web"))}</span> <span class="${"data svelte-8y35po"}"><a${add_attribute("href", station.web, 0)} rel="${"noopener"}" target="${"_blank"}" class="${"svelte-8y35po"}">${escape(formatWebText(station.web))}</a></span></p>
          </div>`
		: ``}
