...
type Week = Record<0 | 1 | 2 | 3 | 4 | 5 | 6, string>

export const weekDays = {} as Record<keyof typeof helper, Week>;

for(const [key, value] of Object.entries(helper)) {
  weekDays[key as keyof typeof helper] = (Object as any).fromEntries(Object.entries(value));
}